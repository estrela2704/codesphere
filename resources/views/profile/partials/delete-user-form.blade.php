<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Após a exclusão da sua conta, todos os recursos e dados associados a ela serão permanentemente apagados. Antes de excluir sua conta, por favor, faça o download de quaisquer dados ou informações que deseje manter.') }}
        </p>
    </header>
